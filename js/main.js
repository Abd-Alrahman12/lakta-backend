...
const translations = {
 ...
 ar: {
    ...
    heroSubtitle: 'نصمم مواقع عصرية وسريعة ومتجاوبة مع الجوال، مخصصة للأعمال التي تعتمد على الانستجرام والسوشال ميديا.',
    heroPrimaryCta: 'اطلب موقعك الآن',
    heroSecondaryCta: 'شاهد أعمالنا',
    heroMeta1: 'جاهز خلال 7 أيام',
    heroMeta2: 'محسّن لزوار الانستجرام',
    heroBadge: 'مثالي لحملات الانستجرام',
    servicesTitle: 'الخدمات',
    servicesSubtitle: 'كل ما تحتاجه لإطلاق حضور احترافي على الإنترنت لجمهور انستجرام.',
    serviceBusinessTitle: 'مواقع الشركات',
    serviceBusinessBody: 'مواقع نظيفة وموثوقة للشركات التي تريد تحويل زوار الانستجرام إلى استفسارات وحجوزات حقيقية.',
    serviceStoreTitle: 'المتاجر الإلكترونية',
    serviceStoreBody: 'تصاميم متاجر بسيطة وفعّالة تسهّل على متابعيك التصفح والشراء.',
    serviceLandingTitle: 'صفحات الهبوط',
    serviceLandingBody: 'صفحات مؤثرة للإعلانات والحملات التي تأتي مباشرة من بايو أو ستوري الانستجرام.',
    servicePortfolioTitle: 'مواقع الأعمال',
    servicePortfolioBody: 'مواقع أعمال بسيطة تعرض مشاريعك وتوصيات عملائك ومحتوى انستجرام بشكل جميل.',
    offersTitle: 'العروض الحالية',
    offersSubtitle: 'باقات لفترة محدودة مخصصة للأعمال التي تنمو عبر الانستجرام.',
    offersEmpty: 'لا توجد عروض نشطة حالياً. تابعنا على الانستجرام للاطلاع على الخصومات القادمة.',
    portfolioTitle: 'الأعمال',
    portfolioSubtitle: 'نماذج من المواقع العصرية والأنيقة التي يمكننا تصميمها لعملك.',
    requestTitle: 'اطلب موقعك',
    requestSubtitle: 'أخبرنا بما تحتاجه وسنتواصل معك بخطة واضحة وجدول زمني وسعر.',
    formNameLabel: 'الاسم',
    formEmailLabel: 'البريد الإلكتروني',
    formPhoneLabel: 'رقم الهاتف (واتساب)',
    formTypeLabel: 'نوع الموقع',
    formTypePlaceholder: 'اختر نوعاً',
    formTypeBusiness: 'موقع شركة',
    formTypeStore: 'متجر إلكتروني',
    formTypeLanding: 'صفحة هبوط',
    formTypePortfolio: 'موقع أعمال',
    formTypeOther: 'أخرى',
    formMessageLabel: 'تفاصيل المشروع',
    formHint: 'سنرد خلال 24 ساعة عبر واتساب أو البريد الإلكتروني.',
    formSubmit: 'إرسال الطلب',
    requestAsideTitle: 'مثالي لنمو الانستجرام',
    requestAsideItem1: 'مصمم ليتناسب مع هوية انستجرام الخاصة بك',
    requestAsideItem2: 'زر واضح للتواصل عبر واتساب أو الرسائل المباشرة',
    requestAsideItem3: 'تحميل سريع على الأجهزة المحمولة',
    requestAsideItem4: 'هيكل صديق لمحركات البحث',
    contactTitle: 'تواصل معنا',
    contactSubtitle: 'أسرع طريقة للتواصل معنا هي عبر واتساب أو رسائل الانستجرام المباشرة.',
    contactEmailTitle: 'البريد الإلكتروني',
    contactWhatsAppTitle: 'واتساب',
    contactWhatsAppLink: 'تحدث معنا على واتساب',
    contactSocialTitle: 'التواصل الاجتماعي',
